  ...
  a_scale_(2.0)
{
  ...
  twist_pub_ = nh_.advertise<geometry_msgs::Twist>("vrep/cmd_vel", 1);
}
...
void TeleopTurtle::keyLoop()
{
  ...
  puts("---------------------------");
  puts("Use arrow keys to move the robot and 'space' to stop. 'q' to quit .");
